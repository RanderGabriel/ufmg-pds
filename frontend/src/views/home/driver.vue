...
export default defineComponent({
  ...
  computed: {
    mapConfig() {
      return {
        ...mapConfig,
        zoom: 14,
        center: { lat: -19.8514471, lng: -43.9744444 },
  ...
  data() {
    return {
      ...
      markers: [
        { id: 'mechanic1', position: { lat: -19.8747162, lng: -43.98012 } },
        { id: 'mechanic2', position: { lat: -19.87148, lng: -43.9814718 } },
        { id: 'mechanic3', position: { lat: -19.8502524, lng: -43.9637101 } },
        { id: 'mechanic4', position: { lat: -19.8571568, lng: -43.9628115 } },
      ],
      lines: [
