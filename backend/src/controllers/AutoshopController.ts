...
class AutoshopController extends BaseController<Autoshop> {
    ...
    public async create(req: express.Request, res: express.Response) {
        try {
            const entity = await autoshopService.create(req.body);
    ...
    public async get(req: express.Request, res: express.Response) {
        try {
            ...
            const entity = await autoshopService.get(id);
    ...
    public async getAll(req: express.Request, res: express.Response) {
        try {
            const entities = await autoshopService.getAll();
    ...
    public async update(req: express.Request, res: express.Response) {
        try {
            const entity = await autoshopService.update(req.body);
    ...
    public async delete(req: express.Request, res: express.Response) {
        try {
            const id = Number(req.query.id) || 0;
            await autoshopService.delete(id);
...
const router = new AutoshopController().router;
